	...
	render() {
		return (
			<section className={visits.wrapper}>
				...
				<h4>Здавалося б, що можна встигнути за один день? Насправді - дуже багато! Одноденні тури по Україні це можливість:</h4>
				<ul>
					<li>	Подивитися на безліч мальовничих місць і цікавих пам'яток, яких в нашій країні просто величезна кількість;</li>
					...
					<li>І багато, багато іншого! Одноденні тури по Україні з Києва - це надзвичайно різноманітний відпочинок!</li>
				</ul>
